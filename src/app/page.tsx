          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="#features" className="block text-sm text-gray-500 hover:text-gray-900">Features</a>
                <a href="#pricing" className="block text-sm text-gray-500 hover:text-gray-900">Pricing</a>
              </div>
            </div>
            <div>
